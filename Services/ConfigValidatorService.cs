...
namespace AppOwnsData.Services
{
    ...
    public class ConfigValidatorService
    {
        ...
        public static string ValidateConfig(IOptions<AzureAd> azureAd, IOptions<PowerBI> powerBI)
        {
            ...
            //else if (string.IsNullOrWhiteSpace(powerBI.Value.RlsReportId1))
            //{
            //    message = "RLS Report Id 1 is not set in appsettings.json file";
            //}
            //else if (string.IsNullOrWhiteSpace(powerBI.Value.RlsReportId2))
            //{
            //    message = "RLS Report Id 2 is not set in appsettings.json file";
            //}
            ...
            //}
            //else if (string.IsNullOrWhiteSpace(powerBI.Value.ReportId2))
            //{
            //    message = "Report Id 2 is not set in appsettings.json file";
            //}
            //else if (string.IsNullOrWhiteSpace(powerBI.Value.ReportId3))
            //{
            //    message = "Report Id 3 is not set in appsettings.json file";
            //}
            //else if (string.IsNullOrWhiteSpace(powerBI.Value.ReportId4))
            //{
            //    message = "Report Id 4 is not set in appsettings.json file";
            //}
